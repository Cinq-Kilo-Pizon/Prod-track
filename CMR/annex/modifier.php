...
<body style="background: url(Untitled-1.png);">
    <?php
       ...
       if(isset($_POST['button'])){
           ...
           if(isset($tb)&&isset($RFID)&&isset($dim)){
                
                include_once "connection.php";
                  $id= $_GET['id'];

                $req = mysqli_query($con,"UPDATE etat SET tb='$tb',pn='$pn',np='$np' ,etat='$etat' ,dim='$dim',fch='$fch',adresse='$adresse',  rrs='$rrs',commentaires='$commentaires' where id=$id ");

                $req = mysqli_query($con,"UPDATE etat SET mmod='$mmod' where id=$id ");
    ...
    ?>
    <div class="form">
        <a href="etat1.php" class="back_btn"><img src="images/back.png"> Retour</a>
