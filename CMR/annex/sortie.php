...
<?php
  ...
  $RFID= $_GET['RFID'];
   ...
   $req = mysqli_query($con , "UPDATE etat SET adresse = 'annex' WHERE RFID='$RFID' ");
    ...
    while($row=mysqli_fetch_assoc($req1)){
     ...
     $req = mysqli_query($con , "INSERT INTO historique values(NULL,'$tb','$dim','$add',current_timestamp(),'$rfid','Sortie','$name') ");
    }
